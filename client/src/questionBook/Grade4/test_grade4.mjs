import Grade4Questions from './GetGrade4Question.mjs';

console.log("Testing Grade 4 Questions...");
...
const checkQuestion = (key, question, index) => {
    ...
    if (question.type === 'mcq') {
        ...
        // Exceptions if any (e.g., Angles might have 4: Acute, Obtuse, Right, Straight)
...
for (const [key, questions] of Object.entries(Grade4Questions)) {
